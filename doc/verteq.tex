...
Pressure downward in the column is assumed to be in hydrostatic equilibrium:
\begin{align}
\eqlabel{ve:pc:hydro-static}
\pg \aleft( \h \aright) &= \Pg + \inner{ \grad{ \dph } }{ \grav } \intg{ \h }{ \LevT }{ \dens_{\nap} }{ \dph } \\
\pw \aleft( \h \aright) &= \Pw - \inner{ \grad{ \dph } }{ \grav } \intg{ \LevB }{ \h }{ \dens_{\wet} }{ \dph } \\
&= \Pw - \inner{ \grad{ \dph } }{ \grav } \left( \intg{ \LevB }{ \LevT }{ \dens_{\wet} }{ \dph } - \intg{ \h }{ \LevT }{ \dens_{\wet} }{ \dph } \right)
\end{align}
...
\pe \aleft( \satn \aleft( \h \aright) \aright) = \Pg - \Pw + \inner{ \grad{ \dph } }{ \grav } \left( \intg{ \h }{ \LevT }{ \dens_{\nap} - \dens_{\wet} }{ \dph } + \intg{ \LevB }{ \LevT }{ \dens_{\wet} }{ \dph } \right)
\end{equation}
...
\Pc \aleft( \LevM \aright) = \pe \aleft( \at{ \satn }{ \LevM } \aright) - \inner{ \grad{ \dph } }{ \grav } \left( \intg{ \LevM }{ \LevT }{ \dens_{\nap} - \dens_{\wet} }{ \dph } + \intg{ \LevB }{ \LevT }{ \dens_{\wet} }{ \dph } \right)
\end{equation}
...
\Pc \aleft( \LevM \aright) = \pe \aleft( \at{ \satn }{ \LevM } \aright) - \inner{ \grad{ \dph } }{ \grav } \left( \left( \dens_{\nap} - \dens_{\wet} \right) \left( \LevT - \LevM \right) + \dens_{\wet} \left( \LevT - \LevB \right) \right)
\end{equation}
